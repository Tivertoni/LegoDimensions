...
public interface ILegoPortal
{
    ...
    /// <summary>
    /// Fades all pads(left, center, right) according to each specific settings.
    /// </summary>
    /// <param name="fadePadCenter">Center pad settings.</param>
    /// <param name="fadePadLeft">Left pad settings.</param>
    /// <param name="fadePadRight">Right pad settings.</param>
